...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/chatserver: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/chatserver ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/BoostTCPServer.o: src/BoostTCPServer.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BoostTCPServer.o src/BoostTCPServer.cpp

${OBJECTDIR}/src/BoostTCPSession.o: src/BoostTCPSession.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/BoostTCPSession.o src/BoostTCPSession.cpp
...
${OBJECTDIR}/src/Redis.o: src/Redis.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Redis.o src/Redis.cpp

${OBJECTDIR}/src/WebsocketServer.o: src/WebsocketServer.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WebsocketServer.o src/WebsocketServer.cpp

${OBJECTDIR}/src/WsClientData.o: src/WsClientData.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WsClientData.o src/WsClientData.cpp

${OBJECTDIR}/src/base64.o: src/base64.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/base64.o src/base64.cpp
